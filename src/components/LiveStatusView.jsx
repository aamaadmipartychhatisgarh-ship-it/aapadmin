...
// Live Status content (online/idle/offline counts + per-user table), extracted
// from /dashboard/supervisor/live so it can be reused both there and inside the
// Analytics tabs. Same data source (/api/supervisor/live, 15s refresh), no dup.
