...
// Organization Strength content (summary bands + district ranking table),
// extracted from /dashboard/strength so it can be reused both there and inside
// the combined Full Ranking tabs — same data source (/api/strength), no dup.
                ...
                <tr key={a.id} className="border-t border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-gray-700 w-14 text-right">{Math.max(0, Math.min(100, Number(a.score) || 0))}%</span>
