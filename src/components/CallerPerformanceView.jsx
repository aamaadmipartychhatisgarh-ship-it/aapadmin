...
// Caller Performance content (date presets + ranked caller table), extracted
// from /dashboard/supervisor/callers so it can be reused both there and as a tab
// inside the Supervisor Overview. Same data source (/api/supervisor/callers),
// no duplicated logic.
...
export default function CallerPerformanceView() {
