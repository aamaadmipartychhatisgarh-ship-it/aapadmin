              ...
              {loading ? (
                ...
                <tr key={r.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    {r.joined_by_name ? (
                      /* An explicit Joined By contact was selected — show that person. */
                      ...
                      /* No explicit Joined By — fall back to the person who ADDED the
                         influencer (the creator/added-by user). */
                      <div className="flex items-center gap-2.5 min-w-[180px]">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-[11px] text-gray-400">Added by</div>
                        </div>
                      </div>
