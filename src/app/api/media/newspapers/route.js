...
export async function POST(req) {
  try {
    ...
    const res = await query(
      `INSERT INTO newspapers (name, circulation, contact_email, contact_phone, sort_order) VALUES (?, ?, ?, ?, ?)`,
      [d.name, d.circulation || null, d.contact_email || null, d.contact_phone || null, Number(d.sort_order) || 0]
    );
