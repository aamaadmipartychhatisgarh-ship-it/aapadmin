...
export async function POST(req, { params }) {
  ...
  try {
    ...
    const res = await query(
      `INSERT INTO la_aap_candidates (assembly_id, photo_url, name, phone, address, date_of_birth, caste, net_worth, business, monthly_income, education, political_experience, organization_experience, previous_elections, current_position)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
