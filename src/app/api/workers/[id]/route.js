...
export async function PUT(req, { params }) {
  try {
    ...
    const fields = ["name","mobile","photo_url","address","zone_id","lok_sabha_id","district_id","assembly_id","ward_id","booth_id","position","skills","activity_score","membership_no","member_since","membership_status","valid_till","worker_type"];
    const sets = [], vals = [];
    ...
    try {
      ...
      // Return the same joined shape as GET/list (district_name, assembly_name,
      // etc.) so the client can merge this response straight into its table
      // row without a second round-trip or a full list refetch.
