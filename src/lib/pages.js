...
export const PAGES = [
  ...
  { key: "calls", label: "Calls", href: "/dashboard/calls", prefixes: ["/dashboard/calls"], icon: "Database",
    roles: [ROLES.CALLER] },
  { key: "contacts", label: "Contacts", href: "/dashboard/admin/contacts", prefixes: ["/dashboard/admin/contacts", "/dashboard/supervisor/contacts", "/dashboard/admin/contacts-hierarchy", "/dashboard/admin/contacts-incomplete", "/dashboard/admin/active-workers"], icon: "UserCheck",
    roles: [...OVERSIGHT] },
